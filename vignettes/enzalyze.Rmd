...
p_data <- data_plotr(dr_uncal, datalabel = "Raw Data site ", site.code = "test_vignette",
                     time.variable = "elapsed", 
                     fluorescence.variable = "RFU", shape = "treatment", 
                     colour = "rep", fill = "rep")
print(p_data)
```
...
p_curve <- curve_plotr(data = d_cal, concentration.variable = "conc.AMC.nM", 
                       fluorescence.variable = "RFU", 
                       curvelabel = "Calibration Curve site ", site.code = "test_vignette")
print(p_curve)
```
