...
p_data <- ggplot(dr_uncal, aes_string(x = "elapsed", y = "RFU",
                                shape = "treatment", colour = "rep", fill = "rep")) +
    geom_point() +
    geom_smooth(method="lm", se=FALSE) +
    facet_wrap( ~ substrate) + 
    ggtitle(paste("Raw Data site_", "vignette_example"))
print(p_data)
```
...
p_calib <- ggplot(d_cal, aes_string(x = "conc.AMC.nM", y = "RFU")) +
    geom_point() +
    geom_smooth(method="lm", se=TRUE) +
    ggtitle(paste0("Calibration Curve For AMC, site ", "vignette_example"))
print(p_calib)
```
...
p_calibrated <- ggplot(lm_dframe, aes_string(x = "substrate", y = "v0", colour = "rep",
    ...
    ggtitle(paste0("Calibrated v0, site ", "vignette_example"))
print(p_calibrated)
```
